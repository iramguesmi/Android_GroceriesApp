...
//ajouter les data au model
        ...
        recentlyViewedList.add(new RecentlyViewed("Bsissa", "Bsissa is a typical Mediterranean food, based on flour of roasted barley which dates back to Roman times.", "TND 19,900","1","KG",R.drawable.bsissacard, R.drawable.bgbsissa));
        recentlyViewedList.add(new RecentlyViewed("Spices: red chilli pepper", "The main oriental spices associated with Tunisian spices, mild chilli pepper ...", "TND 6,500","1","KG",R.drawable.spices, R.drawable.bgspices));
        recentlyViewedList.add(new RecentlyViewed("Pates Coquillette", "Superior pasta made from pure extracted durum wheat semolina.", "TND 0,420","0.5","KG",R.drawable.pates, R.drawable.bgpates));
        recentlyViewedList.add(new RecentlyViewed("Fromage Presedent", "To spread, to cook, or to snack on, President offers you a wide range of cheeses to suit every taste.", "TND 2,750","8","triangle",R.drawable.fromaga, R.drawable.bgfromage));
